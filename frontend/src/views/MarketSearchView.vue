<template>
  <div class="space-y-6">
    <section class="rounded-3xl bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-8 text-white shadow-xl">
        ...
        <article class="rounded-2xl bg-white p-4 shadow">
          ...
          <ul class="mt-3 space-y-2 text-sm text-slate-600">
            <li class="flex items-center justify-between">
              <span>高频曝光</span>
              <span class="rounded-full bg-orange-50 px-2 py-0.5 text-orange-600">实时</span>
            </li>
            <li class="flex items-center justify-between">
              <span>价格偏高</span>
              <span>14</span>
        ...
        <div v-else class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          ...
          >
            ...
            <footer class="mt-4 flex items-center justify-between text-sm text-slate-500">
              ...
              <button class="text-orange-600" type="button">查看详情 →</button>
            </footer>
          </article>
        </div>
